-- Comandero Taberneta — bootstrap completo idempotente
-- Pegar en Supabase SQL Editor (o usar npm run db:bootstrap)
...
-- Fase A pass 2 — eliminar función SQL sin uso en políticas RLS
DROP FUNCTION IF EXISTS ct_is_camarero();
